...
CREATE INDEX `fk_canchas_deporte1_idx` ON `hoy_se_juega`.`canchas` (`deporte_id` ASC);
...
CREATE INDEX `fk_escuelitas_deporte1_idx` ON `hoy_se_juega`.`escuelitas` (`deporte_id` ASC);
...
CREATE INDEX `fk_imagen_canchas_canchas1_idx` ON `hoy_se_juega`.`imagen_canchas` (`canchas_id` ASC);
...
CREATE INDEX `fk_profesor_has_escuelitas_profesor1_idx` ON `hoy_se_juega`.`profesores_escuelitas` (`profesor_id` ASC);
...
CREATE INDEX `fk_torneos_has_horas_owners_horas_owners1_idx` ON `hoy_se_juega`.`torneos_horarios` (`horas_owners_id` ASC);

CREATE INDEX `fk_torneos_has_horas_owners_torneos1_idx` ON `hoy_se_juega`.`torneos_horarios` (`torneos_id` ASC);

CREATE INDEX `fk_torneos_has_horas_owners_dias_owners1_idx` ON `hoy_se_juega`.`torneos_horarios` (`dias_owners_id` ASC);
...
-- -----------------------------------------------------
-- Table `hoy_se_juega`.`users_dias_players`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hoy_se_juega`.`users_dias_players` ;

CREATE TABLE IF NOT EXISTS `hoy_se_juega`.`users_dias_players` (
  `users_players_id` INT NOT NULL,
  `dias_players_id` INT NOT NULL,
  PRIMARY KEY (`users_players_id`, `dias_players_id`),
  CONSTRAINT `fk_users_players_has_dias_players_users_players1`
    FOREIGN KEY (`users_players_id`)
    REFERENCES `hoy_se_juega`.`users_players` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_users_players_has_dias_players_dias_players1`
...
CREATE INDEX `fk_users_players_has_dias_players_dias_players1_idx` ON `hoy_se_juega`.`users_dias_players` (`dias_players_id` ASC);

CREATE INDEX `fk_users_players_has_dias_players_users_players1_idx` ON `hoy_se_juega`.`users_dias_players` (`users_players_id` ASC);


-- -----------------------------------------------------
-- Table `hoy_se_juega`.`users_horas_players`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hoy_se_juega`.`users_horas_players` ;

CREATE TABLE IF NOT EXISTS `hoy_se_juega`.`users_horas_players` (
  `users_players_id` INT NOT NULL,
  `horas_players_id` INT NOT NULL,
  PRIMARY KEY (`users_players_id`, `horas_players_id`),
  CONSTRAINT `fk_users_players_has_horas_players_users_players1`
    FOREIGN KEY (`users_players_id`)
    REFERENCES `hoy_se_juega`.`users_players` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_users_players_has_horas_players_horas_players1`
...
CREATE INDEX `fk_users_players_has_horas_players_horas_players1_idx` ON `hoy_se_juega`.`users_horas_players` (`horas_players_id` ASC);

CREATE INDEX `fk_users_players_has_horas_players_users_players1_idx` ON `hoy_se_juega`.`users_horas_players` (`users_players_id` ASC);
...
-- -----------------------------------------------------
-- Data for table `hoy_se_juega`.`dias_owners`
-- -----------------------------------------------------
START TRANSACTION;
USE `hoy_se_juega`;
INSERT INTO `hoy_se_juega`.`dias_owners` (`id`, `dia`) VALUES (1, 'Lunes');
INSERT INTO `hoy_se_juega`.`dias_owners` (`id`, `dia`) VALUES (2, 'Martes');
INSERT INTO `hoy_se_juega`.`dias_owners` (`id`, `dia`) VALUES (3, 'Miércoles');
INSERT INTO `hoy_se_juega`.`dias_owners` (`id`, `dia`) VALUES (4, 'Jueves');
INSERT INTO `hoy_se_juega`.`dias_owners` (`id`, `dia`) VALUES (5, 'Viernes');
INSERT INTO `hoy_se_juega`.`dias_owners` (`id`, `dia`) VALUES (6, 'Sábado');
INSERT INTO `hoy_se_juega`.`dias_owners` (`id`, `dia`) VALUES (7, 'Domingo');

COMMIT;


-- -----------------------------------------------------
-- Data for table `hoy_se_juega`.`dias_players`
-- -----------------------------------------------------
START TRANSACTION;
USE `hoy_se_juega`;
INSERT INTO `hoy_se_juega`.`dias_players` (`id`, `dia`) VALUES (1, 'Lunes');
INSERT INTO `hoy_se_juega`.`dias_players` (`id`, `dia`) VALUES (2, 'Martes');
INSERT INTO `hoy_se_juega`.`dias_players` (`id`, `dia`) VALUES (3, 'Miércoles');
INSERT INTO `hoy_se_juega`.`dias_players` (`id`, `dia`) VALUES (4, 'Jueves');
INSERT INTO `hoy_se_juega`.`dias_players` (`id`, `dia`) VALUES (5, 'Viernes');
INSERT INTO `hoy_se_juega`.`dias_players` (`id`, `dia`) VALUES (6, 'Sábado');
INSERT INTO `hoy_se_juega`.`dias_players` (`id`, `dia`) VALUES (7, 'Domingo');

COMMIT;


-- -----------------------------------------------------
-- Data for table `hoy_se_juega`.`horas_owners`
-- -----------------------------------------------------
START TRANSACTION;
USE `hoy_se_juega`;
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (1, 00:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (2, 00:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (3, 01:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (4, 01:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (5, 02:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (6, 02:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (7, 03:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (8, 03:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (9, 04:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (10, 04:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (11, 05:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (12, 05:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (13, 06:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (14, 06:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (15, 07:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (16, 07:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (17, 08:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (18, 08:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (19, 09:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (20, 09:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (21, 10:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (22, 10:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (23, 11:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (24, 11:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (25, 12:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (26, 12:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (27, 13:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (28, 13:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (29, 14:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (30, 14:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (31, 15:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (32, 15:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (33, 16:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (34, 16:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (35, 17:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (36, 17:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (37, 18:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (38, 18:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (39, 19:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (40, 19:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (41, 20:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (42, 20:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (43, 21:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (44, 21:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (45, 22:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (46, 22:30);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (47, 23:00);
INSERT INTO `hoy_se_juega`.`horas_owners` (`id`, `hora`) VALUES (48, 23:30);

COMMIT;


-- -----------------------------------------------------
-- Data for table `hoy_se_juega`.`horas_players`
-- -----------------------------------------------------
START TRANSACTION;
USE `hoy_se_juega`;
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (1, '00:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (2, '00:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (3, '01:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (4, '01:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (5, '02:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (6, '02:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (7, '03:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (8, '03:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (9, '04:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (10, '04:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (11, '05:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (12, '05:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (13, '06:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (14, '06:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (15, '07:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (16, '07:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (17, '08:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (18, '08:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (19, '09:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (20, '09:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (21, '10:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (22, '10:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (23, '11:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (24, '11:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (25, '12:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (26, '12:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (27, '13:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (28, '13:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (29, '14:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (30, '14:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (31, '15:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (32, '15:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (33, '16:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (34, '16:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (35, '17:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (36, '17:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (37, '18:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (38, '18:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (39, '19:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (40, '19:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (41, '20:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (42, '20:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (43, '21:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (44, '21:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (45, '22:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (46, '22:30');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (47, '23:00');
INSERT INTO `hoy_se_juega`.`horas_players` (`id`, `hora`) VALUES (48, '23:30');
