...
-- Table `hoy_se_juega`.``
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hoy_se_juega`.`` ;

CREATE TABLE IF NOT EXISTS `hoy_se_juega`.`` (
...
CREATE INDEX `fk_torneos_has_horas_owners_horas_owners1_idx` ON `hoy_se_juega`.`` (`horas_owners_id` ASC);

CREATE INDEX `fk_torneos_has_horas_owners_torneos1_idx` ON `hoy_se_juega`.`` (`torneos_id` ASC);

CREATE INDEX `fk_torneos_has_horas_owners_dias_owners1_idx` ON `hoy_se_juega`.`` (`dias_owners_id` ASC);
...
CREATE TABLE IF NOT EXISTS `hoy_se_juega`.`escuelitas` (
  ...
  `valor` INT NOT NULL,
  `canchas_id` INT NOT NULL,
  PRIMARY KEY (`id`, `deporte_id`, `genero_id`, `canchas_id`),
