...
CREATE TABLE IF NOT EXISTS `hoy_se_juega`.`home_owners` (
  ...
  `logo_owners_id` INT NOT NULL,
  `imagenes_owners_id` INT NOT NULL,
  PRIMARY KEY (`id`, `users_owners_id`, `logo_owners_id`, `imagenes_owners_id`),
  CONSTRAINT `fk_home_owners_users_owners1`
    FOREIGN KEY (`users_owners_id`)
    REFERENCES `hoy_se_juega`.`users_owners` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_home_owners_logo_owners1`
    FOREIGN KEY (`logo_owners_id`)
    REFERENCES `hoy_se_juega`.`logo_owners` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_home_owners_imagenes_owners1`
    FOREIGN KEY (`imagenes_owners_id`)
    REFERENCES `hoy_se_juega`.`imagenes_owners` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE INDEX `fk_home_owners_logo_owners1_idx` ON `hoy_se_juega`.`home_owners` (`logo_owners_id` ASC);

CREATE INDEX `fk_home_owners_imagenes_owners1_idx` ON `hoy_se_juega`.`home_owners` (`imagenes_owners_id` ASC);
...
CREATE TABLE IF NOT EXISTS `hoy_se_juega`.`home_players` (
  ...
  `imagenes_players_id` INT NOT NULL,
  PRIMARY KEY (`id`, `users_players_id`, `imagenes_players_id`),
  CONSTRAINT `fk_home_players_users_players1`
    FOREIGN KEY (`users_players_id`)
    REFERENCES `hoy_se_juega`.`users_players` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_home_players_imagenes_players1`
    FOREIGN KEY (`imagenes_players_id`)
    REFERENCES `hoy_se_juega`.`imagenes_players` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE INDEX `fk_home_players_imagenes_players1_idx` ON `hoy_se_juega`.`home_players` (`imagenes_players_id` ASC);
