...
CREATE TABLE IF NOT EXISTS `hoy_se_juega`.`auto_valoracion` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `users_players_auto_valoracion_id`
    FOREIGN KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `hoy_se_juega`.`deportes_users_player` (
  ...
  PRIMARY KEY (`deportes_id`, `users_players_id`),
...
CREATE INDEX `fk_deportes_has_user_players_user_players1_idx` ON `hoy_se_juega`.`deportes_users_player` (`users_players_id` ASC);
...
CREATE TABLE IF NOT EXISTS `hoy_se_juega`.`users_players` (
  ...
  PRIMARY KEY (`id`, `zonas_de_juego_id`, `auto_valoracion_id`),
...
-- -----------------------------------------------------
-- Data for table `hoy_se_juega`.`deportes`
-- -----------------------------------------------------
START TRANSACTION;
USE `hoy_se_juega`;
...
INSERT INTO `hoy_se_juega`.`deportes` (`id`, `deporte`, `active`) VALUES (4, 'Padel', 1);
INSERT INTO `hoy_se_juega`.`deportes` (`id`, `deporte`, `active`) VALUES (5, 'Tenis', 1);
