...
CREATE TABLE IF NOT EXISTS `hoy_se_juega`.`dias_horarios_users_players` (
  ...
  PRIMARY KEY (`dias_players_id`, `horas_players_id`, `users_players_id`),
...
CREATE INDEX `fk_dias_players_has_horas_players_horas_players1_idx` ON `hoy_se_juega`.`dias_horarios_users_players` (`horas_players_id` ASC);

CREATE INDEX `fk_dias_players_has_horas_players_dias_players1_idx` ON `hoy_se_juega`.`dias_horarios_users_players` (`dias_players_id` ASC);

CREATE INDEX `fk_dias_players_has_horas_players_user_players1_idx` ON `hoy_se_juega`.`dias_horarios_users_players` (`users_players_id` ASC);
...
CREATE TABLE IF NOT EXISTS `hoy_se_juega`.`users_players` (
  ...
  PRIMARY KEY (`id`, `zonas_de_juego_id`, `auto_valoracion_id`, `deportes_players_id`),
...
INSERT INTO `hoy_se_juega`.`deportes_players` (`id`, `deporte`, `active`) VALUES (4, 'Padel', 1);
