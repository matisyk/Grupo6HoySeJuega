...
CREATE TABLE IF NOT EXISTS `hoy_se_juega`.`deportes_users_player` (
  ...
  CONSTRAINT `fk_deportes_has_user_players_user_players1`
    ...
    REFERENCES `hoy_se_juega`.`user_players` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `fk_deportes_has_user_players_user_players1_idx` ON `hoy_se_juega`.`deportes_users_player` (`user_players_id` ASC);

CREATE INDEX `fk_deportes_has_user_players_deportes1_idx` ON `hoy_se_juega`.`deportes_users_player` (`deportes_id` ASC);
...
CREATE INDEX `fk_dias_players_has_horas_players_user_players1_idx` ON `hoy_se_juega`.`dias_horarios_users_players` (`user_players_id` ASC);
...
CREATE INDEX `fk_imagenes_players_user_players1_idx` ON `hoy_se_juega`.`imagenes_players` (`user_players_id` ASC);
...
CREATE INDEX `fk_telefono_owner_user_player_idx` ON `hoy_se_juega`.`telefonos_players` (`user_players_id` ASC);
...
-- -----------------------------------------------------
-- Table `hoy_se_juega`.`user_players`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hoy_se_juega`.`user_players` ;

CREATE TABLE IF NOT EXISTS `hoy_se_juega`.`user_players` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(45) NOT NULL,
  `apellido` VARCHAR(45) NOT NULL,
...
CREATE INDEX `fk_user_players_zonas_de_juego1_idx` ON `hoy_se_juega`.`user_players` (`zonas_de_juego_id` ASC);
